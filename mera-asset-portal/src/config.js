...
// ── Provinces ─────────────────────────────────────────────────────────────────
// To add a province: add a new { code, name } entry below.
// To remove a province: delete (or comment out) the entry.
...
// ── Brands ────────────────────────────────────────────────────────────────────
export const BRANDS = [
  { id: 'litti',       name: 'LITTI.',             color: '#004B6C', provinces: ['ON','AB','SK','MB'] },
  { id: 'greazy',      name: 'GREAZY',              color: '#A2D074', provinces: ['ON','AB','MB'] },
  { id: 'shatterizer', name: 'Shatterizer',         color: '#EDDC61', provinces: ['ON','AB','SK'] },
  { id: 'buddyblooms', name: 'Buddy Blooms',        color: '#f0997b', provinces: ['ON','MB'] },
  { id: 'countryside', name: 'Countryside Cannabis',color: '#97C459', provinces: ['ON'] },
  { id: 'ellevia',     name: 'Ellevia',             color: '#ED93B1', provinces: ['ON','AB','MB'] },
  ]

// ── SKU-level asset types (shown under every product) ─────────────────────────
